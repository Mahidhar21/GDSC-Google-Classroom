...
import {handleGetAllClassrooms,handleCreateClassroom, handleGetClassroom,handleJoinClassroom, handleCreateAnnouncement,handleGetAllAnnouncements} from '../controllers/classroomController.js';
...
classroomRouter.post('/c/stream/:id',handleCreateAnnouncement);
classroomRouter.get('/c/stream/:id',handleGetAllAnnouncements);
